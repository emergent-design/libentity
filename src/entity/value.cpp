...
namespace ent
{
	...
	string encode64(const vector<byte> &value)
	{
		int i;
		long block;
		string result;
	...
	//float value::get(float defaultValue)				{ return this->type == vtype::Float		? this->floating : defaultValue; }
	//double value::get(double defaultValue)				{ return this->type == vtype::Float		? this->floating : defaultValue; }
	//int value::get(int defaultValue)					{ return this->type == vtype::Integer	? this->integer : defaultValue; }
	//long value::get(long defaultValue)					{ return this->type == vtype::Integer	? this->integer : defaultValue; }
	...
	//template <> bool value::is<float>()			{ return this->type == vtype::Float; }
	//template <> bool value::is<double>()		{ return this->type == vtype::Float; }
	//template <> bool value::is<int>()			{ return this->type == vtype::Integer; }
	//template <> bool value::is<long>()			{ return this->type == vtype::Integer; }
