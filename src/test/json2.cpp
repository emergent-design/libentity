...
// 	{
// 		SimpleEntity e;
// 		Assert.Equal(COMPACT_JSON, entity::encode<json>(e));
// 	}


// 	FACT("Compact JSON can be parsed")
// 	{
// 		auto e = entity::decode<json, SimpleEntity>(ALT_JSON);
...
// 	{
// 		SimpleEntity e;
// 		Assert.Equal(PADDED_JSON, entity::encode<prettyjson>(e));
// 	}


// 	FACT("Padded JSON can be parsed")
// 	{
// 		auto e = entity::decode<json, SimpleEntity>(PADDED_JSON);
...
// 		Assert.Equal(u8R"json({"text":"Must\tbe \"escaped\"\n"})json", entity::encode<json>(e));
// 	}


// 	FACT("Strings are unescaped appropriately")
// 	{
// 		auto e = entity::decode<json, TextEntity>(u8R"json({ "text": "Must\tbe \"escaped\"\n" })json");
...
// 	{
// 		auto e = entity::decode<json, CollectionEntity>(COLLECTION_JSON);
...
// 	{
// 		auto e = entity::decode<json, ComplexEntity>(COMPLEX_JSON);
...
// 	{
// 		Assert.Equal("", entity::decode<json, TextEntity>("{}").text);
// 	}


// 	FACT("Can cope with alternative style line endings")
// 	{
// 		Assert.Equal("hello", entity::decode<json, TextEntity>("{ \"a\": 1,\r\n\"text\": \"hello\" }").text);
// 	}


// 	FACT("Can cope with standard JSON number formats")
// 	{
// 		Assert.Equal(42, entity::decode<json, SimpleEntity>(u8R"json({ "integer": 42 })json").integer);
// 		Assert.Equal(3.14, entity::decode<json, SimpleEntity>(u8R"json({ "floating": 3.14 })json").floating);
// 		Assert.Equal(3.141e-10, entity::decode<json, SimpleEntity>(u8R"json({ "floating": 3.141e-10 })json").floating);
// 		Assert.Equal(3.141e-10, entity::decode<json, SimpleEntity>(u8R"json({ "floating": 3.141E-10 })json").floating);
// 		Assert.Equal(12345123456789, entity::decode<json, SimpleEntity>(u8R"json({ "bignumber": 12345123456789 })json").bignumber);
// 		Assert.Equal(123456789123456789123456789.0, entity::decode<json, SimpleEntity>(u8R"json({ "floating": 123456789123456789123456789 })json").floating);
// 	}


// 	FACT("Will ignore unicode encodings")
// 	{
// 		Assert.Equal("\\u2000\\u20ff", entity::decode<json, TextEntity>(u8R"json({ "text":"\u2000\u20ff" })json").text);
// 	}


// 	FACT("Will support unprotected forward slashes")
// 	{
// 		Assert.Equal("http://something", entity::decode<json, TextEntity>(u8R"json({ "text":"http://something" })json").text);
// 	}
...
// 	{
// 		Assert.Throws<exception>([&](){ entity::decode<json, SimpleEntity>(invalid); });
// 	}
// }
