...
TEST_SUITE("bson")
{
	TEST_CASE("simple types can be converted to/from BSON")
	{
	...
	TEST_CASE("arrays can be converted to/from BSON")
	{
	...
	TEST_CASE("object trees can be converted to/from BSON")
	{
								//    |      Length       |Type|  Name   |      Length       |Type|  Name   |       Value       |Foot|Foot|
	...
	TEST_CASE("parser will throw exception if the BSON is invalid")
	{
