...
const string convert(const vector<byte> &data)
{
...
TEST_CASE("simple types can be converted to/from BSON", "[bson]")
{
	map<string, tree> test_vectors = {
		...
		{ convert({ 0x0f,0x00,0x00,0x00,0x05,0x61,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0xff,0x00 }),		tree {{"a", vector<byte> { 0x00, 0xff } }} },	// Binary
	};
